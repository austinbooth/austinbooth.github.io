...
const About = () => {
  return (
    <section className="me">
      ...
      <p>
        At University I studied chemistry and subsequently worked in the
        pharmaceutical and health and safety industries. Following this, I
        worked as a science teacher for 10 years. However for the last few years
        of my teaching career I felt bored and unfulfilled. I wasn't being
        challenged or learning anything new.
      </p>
      <p>
      ...
      <p>
        Much later, whilst working as a teacher, I had a go at programming a PHP
        website that would generate questions for my classes. This sparked my
        interest in programming again and I loved that I'd made something that
        was useful.
      </p>
      <p>
        So I decided to pursue programming much more. I'd heard a lot about data
        science and Python and so decided to learn some basics with{" "}
        <a href="https://www.dataquest.io/" target="_blank">
          Dataquest
        </a>
        . After learning how to use Python to do some basic data analysis and
        machine learning I was hooked! I'd always loved solving problems, and
        this was exactly what I was doing with programming.
      </p>
      <p>
        ...
        . I decided to apply and successfully completed the tech test! This was
        April 2020.
      </p>
      <p>
